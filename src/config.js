...
module.exports = {
  ...
  BOT_FOOTER: process.env.BOT_FOOTER || '> 𝙼𝙰𝙳𝙴 𝙱𝚈 𝙽𝙰𝚃𝚂𝚄𝚃𝙴𝙲𝙷'𝚂 🇨🇬',
  ...
  AUTO_LIKE_EMOJI: ['💋','😶','✨️','💗','🎈','🎉','🥳','❤️','🧫','🐭'],
  MAX_RETRIES: 3,
  MENU_IMAGE: process.env.MENU_IMAGE || 'https://raw.githubusercontent.com/kinggggg444/DENTSU-MD-V10/main/assets/dentsu-md-v10-banner.jpg',
  RCD_IMAGE: process.env.RCD_IMAGE || 'https://raw.githubusercontent.com/kinggggg444/DENTSU-MD-V10/main/assets/dentsu-md-v10-banner.jpg',
  ...
  WEBSITE: process.env.WEBSITE || 'https://dentsu-md-v10.netlify.app/',
